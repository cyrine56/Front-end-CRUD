...
export default function AddEquipement() {
  ...
  const onSubmit = async (e) => {
    ...
    navigate("/coord/equipement");//c'est pour nous diriger vers la page afficher equipement si le nouv equ est ajouté avec succée
  };
...
Formation  </label>
  ...
  <div className="mb-1">
    ...
    <Link className="btn btn-outline-danger mx-2" to="/coord/equipement">
      annuler
    </Link>
  </div>
</form>
